    ...
    <section class="home-section">
        <nav>
            <div class="sidebar-button">
                ...
                <span class="dashboard">Supervisor</span>
            </div>
        ...
        <div class="chart">
            ...
            <script>
            var xValues = ["Sales Agents", "Team Leaders", "Advisor", "No Of New Policies",
                "Total Premium Collecton"
            ];
            var yValues = [65, 77, 25, 15, 65];
            var barColors = [
                "#b91d47",
                "#00aba9",
                "#2b5797",
